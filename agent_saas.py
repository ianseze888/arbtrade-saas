...
def build_ws_prompt(user_id: str, criteria: dict) -> str:
    ...
    return (
        ...
        "CRITICAL FOR ASIN: You MUST provide the real Amazon ASIN for each product.\n"
        "Real ASINs start with B0 and are exactly 10 characters (e.g. B09XK5KFBQ).\n"
        "Search your knowledge of Amazon listings to find the real ASIN.\n"
        "If you cannot confirm a real ASIN, use null - NEVER make up an ASIN.\n"
        "risk_flags must be an ARRAY of strings, never a single string.\n"
        "Example: [{\"name\":\"Product Name\",\"asin\":\"B09XK5KFBQ\",\"bsr\":\"#8,200\","
...
def build_oa_prompt(user_id: str, criteria: dict) -> str:
    ...
    return (
        ...
        "CRITICAL FOR ASIN: Provide the REAL Amazon ASIN (starts with B0, 10 chars).\n"
        "Search your knowledge to find real ASINs. If unsure use null - NEVER fabricate.\n"
